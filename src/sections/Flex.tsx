...
export default function Flex() {
    return (
        <section id="flex" className="container my-5">
            <h2>Flexbox</h2>
            ...
            <p>What this really means is that their <code>display</code> property is automatically set to
                either <code>block</code> or <code>inline</code>.</p>
            <p>Note that <strong>inline elements can't contain block elements</strong>.</p>
            <div className={'container mb-4'}>
                <details>
                    <summary className={'tw:cursor-pointer tw:mb-2 text-muted'}>Common block &amp; inline elements
                    </summary>
                    <table className={'table table-bordered table-sm'}>
                        ...
                        <tbody>
                        <tr>
                            <td><code>&lt;div&gt;</code> — generic container</td>
                            <td><code>&lt;span&gt;</code> — generic inline container</td>
                        </tr>
                        <tr>
                            <td><code>&lt;p&gt;</code> — paragraph</td>
                            <td><code>&lt;a&gt;</code> — anchor / link</td>
                        </tr>
                        <tr>
                            <td><code>&lt;h1&gt;</code>–<code>&lt;h6&gt;</code> — headings</td>
                            <td><code>&lt;strong&gt;</code> — bold emphasis</td>
                        </tr>
                        <tr>
                            <td><code>&lt;ul&gt;</code>, <code>&lt;ol&gt;</code>, <code>&lt;li&gt;</code> — lists</td>
                            <td><code>&lt;em&gt;</code> — italic emphasis</td>
                        </tr>
                        <tr>
                            <td><code>&lt;table&gt;</code> — table</td>
                            <td><code>&lt;img&gt;</code> — image</td>
                        </tr>
                        <tr>
                            <td><code>&lt;form&gt;</code> — form</td>
                            <td><code>&lt;input&gt;</code> — form input</td>
                        </tr>
                        <tr>
                            <td><code>&lt;header&gt;</code>, <code>&lt;footer&gt;</code>, <code>&lt;section&gt;</code>
                            </td>
                            <td><code>&lt;button&gt;</code> — button</td>
                        </tr>
                        <tr>
                            <td><code>&lt;blockquote&gt;</code> — block quote</td>
                            <td><code>&lt;code&gt;</code> — inline code</td>
                        </tr>
                        <tr>
                            <td><code>&lt;pre&gt;</code> — preformatted text</td>
                            <td><code>&lt;label&gt;</code> — form label</td>
                        </tr>
                        </tbody>
                    </table>
                </details>
            ...
            <h4>Live demos</h4>
            <p>Note that there is almost always more than one way to achieve the same visual result.</p>
            <HorizontalExample1/>
            <HorizontalExample2/>
            <VerticalExample1/>
            <VerticalExample2/>
